...
$q=mysqli_query($connect,"select * from tb_employee where emp_id='$uid'");

$f=mysqli_fetch_assoc($q);

$oldpwd=$f["emp_password"];
...
if(isset($save))
{
		if($oldpwd==$op)
		{
			...
			if($crp==$cp)
			{
				...
				$run=mysqli_query($connect,"update tb_employee set emp_password='$cp' where emp_id='$uid'");
